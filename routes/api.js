...
var creatorList = ['@itsmedanzz','@danzzbot'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'DanzzKey') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'DanzzKey') return res.json(loghandler.invalidKey)
